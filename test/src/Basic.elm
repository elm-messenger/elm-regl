...
init _ =
    ...
    , Cmd.batch
        (batchExec execREGLCmd
            [ loadTexture "enemy" "assets/img/enemy.png" Nothing
...
genRenderable model =
    ...
    group []
        ...
        [ P.clear (Color.rgba 0.6 1 0.3 0.3)
        ...
        , P.textboxPro ( 100, 100 ) { defaultTextBoxOption | fonts = [ "consolas" ], text = lorem, size = 70, color = Color.rgba 0.5 0.5 0.5 0.5, thickness = Just 0.5, italic = Just 4, width = Just 1700 }
        ...
        , P.roundedRect ( 500, 400 ) ( 200, 100 ) 20 (Color.rgba 1 1 1 0.5)
